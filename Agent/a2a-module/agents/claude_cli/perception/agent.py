...
from shared.project_context_loader import (
    load_project_status, enhance_query_with_context, refresh_project_status
)

memory = MemorySaver()

# Load project status on startup
PROJECT_STATUS = load_project_status('perception')
...
class PerceptionCLIAgent:
    ...
    def _enhance_query_with_context(self, query: str) -> str:
        """Enhance user query with current project status"""
        return enhance_query_with_context(query, PROJECT_STATUS, 'perception')
    ...
    async def invoke_claude_cli(self, query: Query, session_id: SessionId) -> AgentResponse:
        ...
        """
        try:
            # Enhance query with current project status
